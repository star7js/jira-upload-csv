...
class JiraConfig:
    ...
    def __init__(self):
        self.base_url: str = os.getenv('JIRA_BASE_URL', 'https://your-jira-instance-url')
...
class AppConfig:
    ...
    def __init__(self):
        ...
        self.default_csv_path: str = os.getenv('DEFAULT_CSV_PATH', 'data/main_and_subtasks_multiple.csv')
